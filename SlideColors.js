...
function slideAnimation() {
    ...
    let random = [];
    let widthScreen = container.width;
    for (var i = 0; i < rectangles.length; i++ ) {
        random.push(getRandomInt(1500, 4000));
        widthScreen = widthScreen - width();
        propertyAnimations[i].duration = random[i];
        propertyAnimations[i].property = "x";
        propertyAnimations[i].from = 0;
        propertyAnimations[i].to = widthScreen
